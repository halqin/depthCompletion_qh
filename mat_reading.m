clear all;
load('D:\convnet\depthCompletionNet-master\data\imdb_sparse_1000interpo.mat');
...
imdb_new.images.data(:,:,1:3,:) = imdb.images.data(97:384,:,1:3,501:1000);
...
save('D:\convnet\depthCompletionNet-master\data\imdb_sparse_500interpo_test.mat','imdb','-v7.3');
